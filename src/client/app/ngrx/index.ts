...
export function getNameListState(state$: Observable<IAppState>): Observable<fromHome.IHomeState> {
  return state$.select(s => s.home);
}

export const getNames: any = compose(fromHome.getNames, getNameListState);
